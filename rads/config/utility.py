...
__all__ = ['error_at', 'continue_from', 'source_from_element', 'parse_action',
...
def named_block_processor(tag: str, parser: Parser, node: NamedBlock) \
    ...
    def process(element: Element) -> NamedBlock:
        ...
        try:
            statement = cast(
                Statement, parser(element.down())[0])
